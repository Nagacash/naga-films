  ...
  return (
    <div className="group relative aspect-[4/5] rounded-xl cursor-pointer">
      <div
        ...
        className="absolute inset-0 rounded-xl overflow-hidden border border-white/5 bg-[#0a0a0a] transition-all group-hover:border-[#00ff88]/30 group-hover:scale-[1.02] shadow-2xl"
      >
        {agent.icon_url ? (
          <img
            src={agent.icon_url}
      ...
      {onEdit && (
        <button
          ...
          className="absolute top-3 right-3 w-8 h-8 rounded-full bg-black/60 border border-white/10 flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-all hover:bg-[#00ff88] hover:text-black hover:scale-110 z-10"
        >
...
function ConversationCard({ conv, onClick }) {
  ...
  return (
    <div
      ...
      className="group flex flex-col gap-3 bg-white/[0.03] border border-white/5 rounded-xl p-4 hover:border-[#00ff88]/20 hover:bg-white/5 transition-all cursor-pointer"
    >
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-[10px] font-black text-[#00ff88] uppercase tracking-wider truncate">
    ...
    <div className="h-full flex flex-col bg-[#030303] text-white">
      ...
      <div className="flex-shrink-0 h-16 border-b border-white/5 flex items-center justify-between px-8 bg-black/40">
        <div className="flex items-center gap-8 h-full">
          <h2 className="text-sm font-black uppercase tracking-[0.2em] text-[#00ff88]">
            Agents
          </h2>
        ...
        <button
          ...
          className="px-6 py-2 bg-[#00ff88] text-black text-[10px] font-black uppercase tracking-widest rounded-lg hover:bg-[#ebff66] transition-all active:scale-95 flex items-center gap-2"
        >
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-8">
        {loading ? (
          <div className="h-full flex items-center justify-center">
            <div className="w-10 h-10 border-2 border-white/5 border-t-[#00ff88] rounded-full animate-spin" />
          </div>
        ) : error ? (
          ...
          conversations.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-white/10 gap-4">
              ...
              <button
                ...
                className="text-[10px] text-[#00ff88] hover:text-white border border-[#00ff88]/20 hover:border-white/20 px-4 py-2 rounded-lg transition-colors"
              >
                Browse Templates
              </button>
            </div>
