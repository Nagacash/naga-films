          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full pt-4 animate-fade-in-up">
            {history.map((entry, idx) => (
              <div
                ...
                className="relative group rounded-lg overflow-hidden border border-white/10 bg-[#0a0a0a] shadow-xl hover:border-[#00ff88]/50 transition-all duration-300 flex flex-col cursor-pointer"
              ...
              >
                ...
                <div className="absolute top-2 right-2 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button
                    ...
                    className="p-2 bg-black/60 backdrop-blur-md rounded-full text-white hover:bg-[#00ff88] hover:text-black transition-all border border-white/10"
                  >
                ...
                <div className="p-3 bg-black/80 backdrop-blur-sm border-t border-white/5 flex-1 flex flex-col justify-between gap-2">
                  ...
                  <div className="flex items-center justify-between mt-1 flex-wrap gap-1">
                    <span className="text-[10px] font-bold text-[#00ff88] px-2 py-0.5 bg-[#00ff88]/10 rounded border border-[#00ff88]/20">
          ...
          <div className="flex-1 flex flex-col gap-3 min-h-[80px] justify-between py-1">
            ...
            <div className="flex justify-between gap-2">
              ...
              <div className="flex items-center gap-3 h-full self-end mb-1">
                ...
                >
                  <div className="absolute top-3 right-3 w-1.5 h-1.5 bg-[#00ff88] rounded-full shadow-lg shadow-[#00ff88]/20" />
                  ...
                  <span className="text-xs font-semibold text-white/70 truncate w-full group-hover:text-[#00ff88] transition-colors">
                    {formatSummaryValue()}
                  </span>
                </button>
                ...
                {/* Generate Button */}
                <button
                  className="h-[50px] px-8 bg-[#00ff88] text-black rounded-md font-medium text-sm hover:bg-[#33ffa3] hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#00ff88]/10 disabled:opacity-50 disabled:cursor-not-allowed"
