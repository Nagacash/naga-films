          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 pt-2 border-t border-white/[0.03] relative">
            ...
            <div className="flex items-center gap-2 relative flex-wrap pb-1 md:pb-0">
              ...
              <div className="relative">
                ...
                >
                  <div className="w-4 h-4 bg-[#00ff88] rounded flex items-center justify-center">
            ...
            <button
              ...
              disabled={generating}
              className="bg-[#00ff88] text-black px-4 py-2 rounded-md font-medium text-sm hover:bg-[#33ffa3] hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 w-full sm:w-auto shadow-lg shadow-[#00ff88]/10 disabled:opacity-50 disabled:cursor-not-allowed z-10"
            >
              {generating ? (
                <>
