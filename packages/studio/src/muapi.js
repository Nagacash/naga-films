...
/**
 * MuAPI is reached via same-origin rewrite (/api/v1, /api/workflow, …). The browser would
...
export async function getTemplateWorkflows(apiKey) {
    const response = await apiFetch(`${BASE_URL}/workflow/get-template-workflows`, {
        headers: {
            'Content-Type': 'application/json',
            'x-api-key': apiKey
        }
...
export async function getUserWorkflows(apiKey) {
    const response = await apiFetch(`${BASE_URL}/workflow/get-workflow-defs`, {
        headers: {
            'Content-Type': 'application/json',
            'x-api-key': apiKey
        }
...
export async function getPublishedWorkflows(apiKey) {
    const response = await apiFetch(`${BASE_URL}/workflow/get-published-workflows`, {
        headers: {
            'Content-Type': 'application/json',
            'x-api-key': apiKey
        }
...
export async function updateWorkflowName(apiKey, workflowId, name) {
    const response = await apiFetch(`${BASE_URL}/workflow/update-name/${workflowId}`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'x-api-key': apiKey
...
export async function deleteWorkflow(apiKey, workflowId) {
    const response = await apiFetch(`${BASE_URL}/workflow/delete-workflow-def/${workflowId}`, {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json',
            'x-api-key': apiKey
...
export async function getWorkflowInputs(apiKey, workflowId) {
    const response = await apiFetch(`${BASE_URL}/workflow/${workflowId}/api-inputs`, {
        headers: {
            'Content-Type': 'application/json',
            'x-api-key': apiKey
        }
...
export async function executeWorkflow(apiKey, workflowId, inputs) {
    const response = await apiFetch(`${BASE_URL}/workflow/${workflowId}/api-execute`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'x-api-key': apiKey
...
export async function getAllNodeSchemas(apiKey, workflowId) {
    const response = await apiFetch(`${BASE_URL}/workflow/${workflowId}/node-schemas`, {
        headers: {
            'Content-Type': 'application/json',
            'x-api-key': apiKey
        }
...
export async function getWorkflowData(apiKey, workflowId) {
    const response = await apiFetch(`${BASE_URL}/workflow/get-workflow-def/${workflowId}`, {
        headers: {
            'Content-Type': 'application/json',
            'x-api-key': apiKey
        }
...
export async function getNodeSchemas(apiKey, workflowId) {
    const response = await apiFetch(`${BASE_URL}/workflow/${workflowId}/api-node-schemas`, {
        headers: {
            'Content-Type': 'application/json',
            'x-api-key': apiKey
        }
...
export async function runSingleNode(apiKey, workflowId, nodeId, payload) {
    const response = await apiFetch(`${BASE_URL}/workflow/${workflowId}/node/${nodeId}/run`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'x-api-key': apiKey
...
export async function deleteNodeRun(apiKey, nodeRunId) {
    const response = await apiFetch(`${BASE_URL}/workflow/node-run/${nodeRunId}`, {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json',
            'x-api-key': apiKey
...
export async function getNodeStatus(apiKey, runId) {
    const response = await apiFetch(`${BASE_URL}/workflow/run/${runId}/status`, {
        headers: {
            'Content-Type': 'application/json',
            'x-api-key': apiKey
        }
...
export async function calculateDynamicCost(apiKey, taskName, payload) {
    const response = await apiFetch(`${V1_URL}/app/calculate_dynamic_cost`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'x-api-key': apiKey
...
export async function registerAppInterest(apiKey, appName) {
    const response = await apiFetch(`${BASE_URL}/app/interest`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'x-api-key': apiKey
...
export async function getAppInterests(apiKey) {
    const response = await apiFetch(`${BASE_URL}/app/interests`, {
        headers: {
            'Content-Type': 'application/json',
            'x-api-key': apiKey
        }
