      ...
      {isHeaderVisible && (
        <header className="flex-shrink-0 h-14 border-b border-white/[0.03] flex items-center justify-between px-6 bg-black/20 backdrop-blur-md z-40">
          ...
          <div className="flex items-center gap-3">
            <img src="/assets/website-images/logo.png" alt="Logo" className="w-9 h-9 object-contain" />
            <span className="text-sm font-bold tracking-tight hidden lg:block">Naga Film <span className="text-white/40 font-medium">"OpenGenerativeAI"</span></span>
          </div>
